        ...
        try {
          ...
          if (!mLeDevices.isEmpty()) {
            ...
            mBluetoothGatt = mLeDevices.get(index - 1)
                .connectGatt(activity, autoReconnect, mGattCallback, BluetoothDevice.TRANSPORT_LE);
          ...
          if (!mLeDevices.isEmpty()) {
            for (BluetoothDevice bluetoothDevice : mLeDevices) {
              if (bluetoothDevice.getAddress().equals(address)) {
                forceDisconnect();
                mBluetoothGatt = bluetoothDevice.connectGatt(activity, autoReconnect, mGattCallback, BluetoothDevice.TRANSPORT_LE);
                if (mBluetoothGatt != null) {
                  //TODO(Will): Delete the puts to this map
